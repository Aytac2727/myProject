        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Category1_ID = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber1 = table.Column<int>(type: "int", nullable: true),
                    PhoneNumber2 = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShopSiteName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LinkName = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Socialİcon = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    publishing = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Language = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    PdfLink = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    InStok = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlacedOn = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    DeliveryChanges = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SliderToImages", x => x.ID);
                    table.ForeignKey(
                        name: "FK_SliderToImages_Sliders_SliderID",
                        column: x => x.SliderID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Genre_To_Product", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Genre_To_Product_Genres_GenreID",
                        column: x => x.GenreID,
                        principalTable: "Genres",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Genre_To_Product_Products_ProductID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Shop_To_Products", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Shop_To_Products_Products_ProductID",
                        column: x => x.ProductID,
                        principalTable: "Products",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Shop_To_Products_Shops_ShopID",
                        column: x => x.ShopID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Genre_To_Product_GenreID",
                table: "Genre_To_Product",
                column: "GenreID");

            migrationBuilder.CreateIndex(
                name: "IX_Genre_To_Product_ProductID",
                table: "Genre_To_Product",
                column: "ProductID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shop_To_Products_ProductID",
                table: "Shop_To_Products",
                column: "ProductID");

            migrationBuilder.CreateIndex(
                name: "IX_Shop_To_Products_ShopID",
                table: "Shop_To_Products",
                column: "ShopID");

            migrationBuilder.CreateIndex(
                name: "IX_SliderToImages_SliderID",
